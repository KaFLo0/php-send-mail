...
require '../send-mail/libs/PHPMailer/OAuthTokenProvider.php';
require '../send-mail/libs/PHPMailer/DSNConfigurator.php';
require '../send-mail/libs/PHPMailer/Exception.php';
require '../send-mail/libs/PHPMailer/OAuth.php';
require '../send-mail/libs/PHPMailer/PHPMailer.php';
require '../send-mail/libs/PHPMailer/POP3.php';
require '../send-mail/libs/PHPMailer/SMTP.php';
